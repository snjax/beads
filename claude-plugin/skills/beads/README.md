...
A comprehensive skill for using [beads](https://github.com/snjax/beads) (bd) issue tracking with Claude Code.
...
- [bd CLI](https://github.com/snjax/beads) installed (`brew install beads`)
...
This skill is maintained at [github.com/snjax/beads](https://github.com/snjax/beads) in the `claude-plugin/skills/beads/` directory.
