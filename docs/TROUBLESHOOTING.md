...
2. **Verify file integrity before excluding**:
   ...
   shasum -a 256 bd
   ```
   Compare with checksums from the [GitHub release page](https://github.com/snjax/beads/releases)
...
**Note:** The `--hard` and `--skip-init` flags mentioned in [GH#479](https://github.com/snjax/beads/issues/479) were never implemented. Use the workarounds above for a complete reset.

**Related:** [GH#922](https://github.com/snjax/beads/issues/922)
...
- GitHub issue [#353](https://github.com/snjax/beads/issues/353) for background
...
1. **Check existing issues**: [GitHub Issues](https://github.com/snjax/beads/issues)
...
3. **File a bug report**: Include:
   ...
   - Steps to reproduce
4. **Join discussions**: [GitHub Discussions](https://github.com/snjax/beads/discussions)
