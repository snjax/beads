...
1. **Read the full docs**: https://github.com/snjax/beads
2. **Try the quickstart**: `bd quickstart` (interactive tutorial)
3. **Set up MCP**: For local Claude Desktop integration
4. **Explore examples**: https://github.com/snjax/beads/tree/main/examples

## 🔗 Resources

- [beads GitHub](https://github.com/snjax/beads)
...
- [File an issue](https://github.com/snjax/beads/issues)
- [Read the FAQ](https://github.com/snjax/beads/blob/main/FAQ.md)
- [Check troubleshooting](https://github.com/snjax/beads/blob/main/TROUBLESHOOTING.md)
